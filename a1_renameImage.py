...
if __name__ == "__main__":
    #renameByNumber("./data/tlc/color/train")
    addKeyForImage("./data/tlc/color/train/e", ".", "_e_.")
    addKeyForImage("./data/tlc/color/train/r", ".", "_r_.")
    addKeyForImage("./data/tlc/color/train/g", ".", "_g_.")
    addKeyForImage("./data/tlc/color/train/y", ".", "_y_.")
