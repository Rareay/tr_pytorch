...
def load_image_pytorch(imgfile):
    ...
    #rmalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--protofile', default='.prototxt', type=str)
    parser.add_argument('--weightfile', default='.caffemodel', type=str)
    parser.add_argument('--model', default="0.pt", type=str)
